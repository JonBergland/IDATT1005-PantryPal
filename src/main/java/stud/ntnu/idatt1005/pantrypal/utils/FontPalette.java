...
public final class FontPalette {
  public static final Font HEADER = Font.font("Times new roman", FontWeight.MEDIUM, 100);
  ...
  public static final Font SHOPPING_LIST = Font.font("Times new roman", FontWeight.BOLD, 30);
